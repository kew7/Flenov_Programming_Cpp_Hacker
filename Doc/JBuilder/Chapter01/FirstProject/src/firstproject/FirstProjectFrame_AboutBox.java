...
public class FirstProjectFrame_AboutBox extends JDialog implements ActionListener {
  ...
  String product = "First project";
  String version = "2.0";
  String copyright = "Copyright (c) Flenov Mikhail";
  String comments = "";
  public FirstProjectFrame_AboutBox(Frame parent) {
    super(parent);
