...
public class FirstProjectFrame extends JFrame {
  ...
  class MyAccessException extends Exception{
    private int Error;

    MyAccessException(int Error){
      this.Error = Error;
    }

    public String toString(){
      return "Access exception "+Error;
    }
  }
  ...
  void jButton4_actionPerformed(ActionEvent e) {
    try{
      throw new MyAccessException(1);
    }
    catch (MyAccessException ex){
