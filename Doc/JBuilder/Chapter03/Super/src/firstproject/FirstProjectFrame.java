...
public class FirstProjectFrame extends JFrame {
  ...
  int Factorial(int factor){
    ...
    int count = Factorial(factor-1)*factor;

    return count;
  }

  void jButton4_actionPerformed(ActionEvent e) {
    Quad MyQuad1 = new Quad(10, 10);
    Cube MyCube1 = new Cube(10, 20, 5);
    Cube MyCube2 = new Cube(20, 30, 10);

    MyCube2.b=5;
    MyQuad1.ic.InnerClassFunc();

    jLabel1.setText("Cube1.b: " + MyCube1.b);
  }
}
