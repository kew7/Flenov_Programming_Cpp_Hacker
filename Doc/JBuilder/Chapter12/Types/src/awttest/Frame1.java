...
public class Frame1 extends JFrame {
  ...
  private void jbInit() throws Exception  {
    ...
    jStartThreadBtn.setBounds(new Rectangle(130, 117, 134, 26));
    jStartThreadBtn.setFont(new java.awt.Font("Dialog", 1, 12));
    jStartThreadBtn.setText("test");
  ...
  void jStartThreadBtn_actionPerformed(ActionEvent e) {
    ...
    System.out.println(i.toHexString(10));
    System.out.println(i.toBinaryString(10));
