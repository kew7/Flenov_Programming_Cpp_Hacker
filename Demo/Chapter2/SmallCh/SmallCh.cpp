// SmallCh.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_SMALLCH, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_SMALLCH);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDI_SMALLCH);
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= (LPCTSTR)IDC_SMALLCH;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		{
		// Turn off monitor
		case ID_MYCOMMAND_TURNOFFMONITOR:
			SendMessage(hWnd, WM_SYSCOMMAND, SC_MONITORPOWER, 0);
			break;
		// Run CPL file
		case ID_MYCOMMAND_RUNCPL:
			ShellExecute(hWnd, "Open", "Rundll32.exe", 
				"shell32,Control_RunDLL main.cpl", "",SW_SHOWNORMAL);
			break;
		// Open and Close CD-ROM
		case ID_MYCOMMAND_OPENCD:
		...
		case ID_MYCOMMAND_CLOSECLOCK:
			...
			break;
		case ID_MYCOMMAND_HIDEALLWINDOWS:
			while (true)
			{
			...
			break;
		case ID_MYCOMMAND_DESKTOPWALLPAPER:
