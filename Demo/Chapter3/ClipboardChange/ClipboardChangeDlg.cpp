// ClipboardChangeDlg.cpp : implementation file
//
...
CClipboardChangeDlg::CClipboardChangeDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CClipboardChangeDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CClipboardChangeDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}
...
// CClipboardChangeDlg message handlers

BOOL CClipboardChangeDlg::OnInitDialog()
{
...
void CClipboardChangeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CClipboardChangeDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CClipboardChangeDlg::OnQueryDragIcon()
{
...
void CClipboardChangeDlg::OnChangeCbChain(HWND hWndRemove, HWND hWndAfter) 
{
    ...
    if ( NULL != ClipboardViewer )
        {
        ::SendMessage ( ClipboardViewer, WM_CHANGECBCHAIN, 
