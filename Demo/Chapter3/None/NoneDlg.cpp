// NoneDlg.cpp : implementation file
//
...
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_LIST1, ItemsList);
}
...
void CNoneDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CNoneDlg::OnQueryDragIcon()
{
